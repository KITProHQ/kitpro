...
3. Verify the downloaded package checksum, then install the `.deb` with `apt install ./kitpro-server_0.1.0~alpha1_amd64.deb`.
...
`kitpro-server-0.1.0_alpha1-1-x86_64.pkg.tar.zst` using `pacman -U`.
